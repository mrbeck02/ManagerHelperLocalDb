...
namespace ManagerHelperLocalDb.Migrations
{
    ...
    [Migration("20230920154723_SpecifyingNullableFields")]
    partial class SpecifyingNullableFields
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ManagerHelperLocalDb.Data.Entities.Team", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("DeveloperTeam", b =>
                {
                    b.HasOne("ManagerHelperLocalDb.Data.Entities.Developer", null)
                        .WithMany()
                        .HasForeignKey("DevelopersId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ManagerHelperLocalDb.Data.Entities.Team", null)
                        .WithMany()
